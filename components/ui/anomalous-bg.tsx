  ...
  useEffect(() => {
    ...
    const material = new THREE.ShaderMaterial({
      uniforms: {
        ...
        color: { value: new THREE.Color(0x4f86f7) },
      },
      vertexShader: `
        uniform float time;
        ...
        void main(){
          vNormal   = normal;
          vPosition = position;
          float d   = snoise(position * 2. + time * .5) * .25;
      ...
      fragmentShader: `
        ...
        void main(){
          ...
          float fresnel = 1. - dot(n, vec3(0., 0., 1.));
          fresnel = pow(fresnel, 2.);
          vec3 col  = color * diffuse + color * fresnel * .6;
